...
export default function Accueil() {
  ...
  return (
    <div
      className="font-[Cormorant_Garamond] text-[#7E7266] bg-[#F9F8F6]"
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'grid', placeItems: 'center' }}>
          <h1
            className="m-0 font-normal tracking-[0.1em] text-white"
            style={{ textShadow: '0 2px 18px rgba(0,0,0,0.35)', fontSize: '8vw' }}
          >
            Âme du Monde
          </h1>
        </div>
      ...
      >
        ...
        >
          <div style={{ width: 'min(1160px, 92%)', margin: '0 auto', padding: '0 24px' }}>
            <h2
              className="m-0"
              style={{ fontSize: 'clamp(24px,6vw,64px)', lineHeight: 1.08, textAlign: 'left', minHeight: '1.1em' }}
            >
              {A.slice(0, countA)}
            </h2>
            <h2
              className="m-0"
              style={{ fontSize: 'clamp(24px,6vw,64px)', lineHeight: 1.08, textAlign: 'right', marginTop: 16, minHeight: '1.1em' }}
            >
              {B.slice(0, countB)}
            </h2>
          </div>
          ...
          >
            ...
            >
              <div style={{ maxWidth: '56ch' }}>
                <h2 className="m-0 text-[#0B0B0B]"
                    style={{ fontSize: 'clamp(38px,3.6vw,52px)', letterSpacing: '.02em' }}>
                  Notre agence
                </h2>
                <p className="mt-3 font-sans"
                   style={{ fontSize: 'clamp(20px,1.6vw,22px)', lineHeight: 1.7 }}>
          ...
          >
            ...
            <div style={{ flex: '1 1 300px', minWidth: 280, display: 'flex', alignItems: 'center' }}>
              <p className="m-0 font-sans"
                 style={{ fontSize: 'clamp(20px,1.6vw,22px)', lineHeight: 1.75 }}>
